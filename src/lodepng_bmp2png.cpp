...
bool lodepng_bmp2png::bmp2png(std::string bmpfilename, std::string pngfilename)
{
  std::vector<unsigned char> bmp;
  lodepng::load_file(bmp, bmpfilename);
  ...
  //unsigned error = lodepng::encode(png, image, 320, 240);
